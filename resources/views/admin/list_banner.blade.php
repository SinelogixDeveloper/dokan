                              ...
                              <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                   <div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/dokan/public') }}/banner_images/{{ $row->bannerimages }}" class="zoomable-thumb" style="position: relative;"></div>
                                                </td>
