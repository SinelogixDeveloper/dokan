         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  ...
                  <form id="ecat" method="post" action="{{url('/admin/update-brand')}}" enctype="multipart/form-data">
                  {{ csrf_field() }}
                  <div class="cph">
                     <div class="row section-header justify-content-between">
                        <div class="cus_title col-md-2">
                           <font style="vertical-align: inherit;">Update Brand</font>
                        </div>
                        <div class="options float-right">
                           <button type="submit" name="save" value="save" class="btn btn-primary">
                           <i class="fa fa-check"></i>
                           <span><font style="vertical-align: inherit;">Update</font></span>
                           </button>
                        </div>
                     </div>
                     @if ($errors->any())
                     ...
                     <div class="cus_dashboard">
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label><font style="vertical-align: inherit;">Brand Name(English)</font>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="brand_name_en" type="text" value="{{$brands->name}}">
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label><font style="vertical-align: inherit;">Brand Name(Arabic)</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The category's name."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="brand_name_er" type="text" value="{{ $brands->getTranslation('name', 'ar') }}">
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                        ...
                        alt="preview image" style="max-height: 150px;"> -->
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label><font style="vertical-align: inherit;">Status</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The category's name."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData" style="margin-top: 10px;">
                                                         ...
                                                         <input name="status" type="checkbox" value="1" {{ ($brands->status == 1) ? 'checked=checked' : '' }} style="width: 20px;height: 25px;">
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             </table>
