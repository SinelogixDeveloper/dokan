         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form id="addcat" action="{{ url('/admin/product/update',$product->id)}}" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     {{ method_field('PATCH') }}
                  <div class="cph">
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                      ...
                                                      <td class="adminData">
                                                         <select data-val="true" data-val-number="The field 'Badge stil' must be a number." data-val-required="" id="product_categories" name="product_categories" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">
                                                          <option  value="">Select Category</option>
                                                            ...
                                                            <option value="{{ $category->id }}" {{ $product->product_categories == $category->id ? 'selected' : '' }}><font style="vertical-align: inherit;">{{ $category->category_name }}</font></font>
                                                            </option>
                                                            @endforeach
                                                         </select>
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            ...
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The name of the product in english."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            ...
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The name of the product in arabic."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <div>
                                                            <input class="jscolor" name="background_color" value="{{ $product->background_color }}">
                                                            ...
                                                            <div class="fileupload-controls">
                                                               <div class="fileupload">
                                                                  <div class="fileupload-buttons">
                                                                     <img id="image_preview_container" src="{{ URL::to('/auraqatar/public') }}/product_images/{{ $product->featured_images }}"
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="AllowCustomersToSelectPageSize"><font style="vertical-align: inherit;">New Arrival</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="Whether customers can choose the page size from a predefined list of options."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                         <select  class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="new_arrival">
                                                            <option  value=""></option>
                                                            <option value="1" {{ $product->new_arrival == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Yes</font>
                                                            </option>
                                                            <option value="0" {{ $product->new_arrival == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">No</font>
                                                            </option>
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
                                                    ...
                                                    <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="AllowCustomersToSelectPageSize"><font style="vertical-align: inherit;">Best Offer</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="Whether customers can choose the page size from a predefined list of options."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                         <select  class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="best_offer">
                                                            <option  value=""></option>
                                                            <option value="1" {{ $product->best_offer == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Yes</font>
                                                            </option>
                                                            <option value="0" {{ $product->best_offer == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">No</font>
                                                            </option>
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <select id="reason" class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="approve_status">
                                                            <option  value=""></option>
                                                            <option value="1" {{ $product->approve_status == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Approve</font>
                                                            </option>
                                                            <option value="0" {{ $product->approve_status == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">Disapprove</font>
                                                            </option>
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
                                                   ...
                                                   <tr id="hide">
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="admin_comment" type="text" value="{{ $product->reason_for_disapprove}}">                   
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label><font style="vertical-align: inherit;">PRODUCT BRAND</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="The name of the product in arabic."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                         <select class="form-control list-box tri-state select2-hidden-accessible" tabindex="-1" aria-hidden="true" name="product_brand">
                                                            @foreach($brands as $brand)
                                                                <option value="{{$brand->id}}" {{($brand->name == $selected_brand->getTranslation('name', 'en')) ? "selected" : ""}}>{{$brand->name}}</option>
                                                            @endforeach
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
                                                   ...
                                                   <!--       @foreach($data as $category)-->
                                                   <!--         <option value="{{ $category->id }}"><font style="vertical-align: inherit;">{{ $category->category_name }}</font></font>-->
                                                   <!--         </option>-->
                                                   <!--         @endforeach-->
                                                   <!--     </select>-->
                                                   <!--   </td>-->
