                                    ...
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                              <td>{{ $number }}</td>
                                             @if($row->not_status =='0')
                                             <td style="color:red;"><a href="{{ url('admin/product/edit', $row->product_id )}}" >{{ $row->not_msg }}</a></td>
                                             @else
                                             <td style="background-color: white;"><a href="{{ url('admin/product/edit', $row->product_id )}}" >{{ $row->not_msg }}</a></td>
                                             @endif
                                             <td align="center"><a href="{{ url('admin/notification/read', $row->id )}}">Read</a></td>
                                             <td class="t-last"><a href="{{ url('admin/notification/remove', $row->id )}}"  class="t-button t-grid-delete delete">REMOVE</a></td>
                                             <?php $number++; ?>
                                          </tr>
                                          @endforeach
                                       </tbody>
