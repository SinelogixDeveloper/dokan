                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center"><a href="{{ url('admin/clientlogo/edit', $row->id )}}">
                                                   <div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/dokan/public') }}/client_logo/{{ $row->logo_grey_images }}" class="zoomable-thumb" style="position: relative;"></div></a>
                                                </td>
                                                <td style="text-align:center;"><div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/dokan/public') }}/client_logo/{{ $row->logo_org_images }}" class="zoomable-thumb" style="position: relative;"></div></td>
