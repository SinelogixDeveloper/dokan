                                 ...
                                 <div class="table-responsive">
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td>
                                                   <div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/dokan/public/') }}/user_images/{{ $row->profile_images }}" class="zoomable-thumb" style="position: relative;"></div>
                                                </td>
