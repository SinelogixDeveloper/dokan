                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="category_name_en" value="{{ $category->category_name }}" type="text" value="">                                
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="category_name_ar" type="text" value="{{ $category->getTranslation('category_name', 'ar') }}"> <span class="text-danger">{{ $errors->first('category_name') }}</span>                               
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="BadgeStyle"><font style="vertical-align: inherit;">Parent Category</font>
                                                      ...
                                                      <td class="adminData">
                                                         <select data-val="true" data-val-number="The field 'Badge stil' must be a number." data-val-required="" id="parent_category" name="parent_category_en" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">
                                                          <option  value="">Select English Parent Category</option>
                                                            @foreach($data as $category)
                                                            <option value="{{ $category->id }}"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $category->getTranslation('category_name', 'en') }}</font></font>
                                                            </option>
                                                            @endforeach
                                                         </select>
                                                   ...
                                                   <!--   <td class="adminTitle">-->
                                                   <!--      <div class="ctl-label">-->
                                                   <!--         <label for="BadgeStyle"><font style="vertical-align: inherit;">Parent Category(Ar)</font>-->
                                                   <!--         </label><a class="hint" href="#" onclick="return false;" tabindex="-1" title="Retrieves or sets the type of brand to be displayed next to the category link in the menus"  data-toggle="tooltip" data-placement="left"><i class="fa fa-question-circle"></i></a>-->
                                                   <!--      </div>-->
                                                   <!--   </td>-->
                                                   <!--   <td class="adminData">-->
                                                   <!--      <select data-val="true" data-val-number="The field 'Badge stil' must be a number." data-val-required="" id="parent_category" name="parent_category_ar" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">-->
                                                   <!--       <option  value="">Select Arabic Parent Category</option>-->
                                                   <!--         @foreach($data as $category)-->
                                                   <!--         <option value="{{ $category->getTranslation('category_name', 'ar') }}"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $category->getTranslation('category_name', 'ar') }}</font></font>-->
                                                   <!--         </option>-->
                                                   <!--         @endforeach-->
                                                   <!--      </select>-->
                                                   <!--      <i class="fas fa-caret-down sel_dwn-add_new"></i>-->
                                                   ...
                                                   <!--   </td>-->
                                                   <!--   <td class="adminData">-->
                                                   <!--      <input class="text-box single-line" name="sub_category_name" value="{{ $category->sub_category_name }}" type="text" value="">                                -->
                                                   <!--   </td>-->
                                                   <!--</tr>-->
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label ><font style="vertical-align: inherit;">Description</font>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="category_description" value="{{ $category->category_description }}" type="text" value="">                                
                                                      </td>
                                                   </tr>
                                                   <!--<tr>-->
                                                   <!--   <td class="adminTitle">-->
                                                   ...
                                                   <!--   </td>-->
                                                   <!--   <td class="adminData">-->
                                                   <!--      <input class="text-box single-line" name="cat_badge" value="{{ $category->cat_badge }}" type="text" value="">                                -->
                                                   <!--   </td>-->
                                                   <!--</tr>-->
                                                   <tr class="brek">                    
                                                   </tr>
                                                   ...
                                                   <!--         <option selected="selected" value="0" {{ $category->badgestyle == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Secondary</font></font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="1" {{ $category->badgestyle == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Primary</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="2" {{ $category->badgestyle == 2 ? 'selected' : '' }}><font style="vertical-align: inherit;">Success</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="3" {{ $category->badgestyle == 3 ? 'selected' : '' }}><font style="vertical-align: inherit;">Info</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="4" {{ $category->badgestyle == 4 ? 'selected' : '' }}><font style="vertical-align: inherit;">Warning</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="5" {{ $category->badgestyle == 5 ? 'selected' : '' }}><font style="vertical-align: inherit;">Danger</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="6" {{ $category->badgestyle == 6 ? 'selected' : '' }}><font style="vertical-align: inherit;">Light</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="7" {{ $category->badgestyle == 7 ? 'selected' : '' }}><font style="vertical-align: inherit;">Dark</font>-->
                                                   <!--         </option>-->
                                                   <!--      </select>-->
                                                   <!--      <i class="fas fa-caret-down sel_dwn-add_new"></i>-->
                                                   <!--   </td>-->
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="PictureId"><font style="vertical-align: inherit;">Category Picture
                                                            </font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="Select images by 38*35.
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <select data-val="true" data-val-number="The field 'Badge stil
                                                            ...
                                                            <option value=""></option>
                                                            <option value="1" {{ $category->cat_status == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Active</font></font>
                                                            </option>
                                                            <option value="0" {{ $category->cat_status == 0 ? 'selected' : '' }}><font style="vertical-align: inherit;">Inactive</font>
                                                            </option>
                                                         </select>
                                                         <i class="fas fa-caret-down sel_dwn-add_new"></i>
                                                      </td>
                                                   ...
                                                   <!--         <option value=""></option>-->
                                                   <!--         <option value="grid" {{ $category->displaymode == 'grid' ? 'selected' : '' }}><font style="vertical-align: inherit;">GRID</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="list" {{ $category->displaymode == 'list' ? 'selected' : '' }}><font style="vertical-align: inherit;">List</font>-->
                                                   <!--         </option>-->
                                                   <!--      </select>-->
                                                   <!--      <i class="fas fa-caret-down sel_dwn-add_new"></i>-->
                                                   <!--   </td>-->
                                                   ...
                                                   <!--         <option value="true" {{ $category->pagesize == 'true' ? 'selected' : '' }}><font style="vertical-align: inherit;">Yes</font>-->
                                                   <!--         </option>-->
                                                   <!--         <option value="false" {{ $category->pagesize == 'false' ? 'selected' : '' }}><font style="vertical-align: inherit;">No</font>-->
                                                   <!--         </option>-->
                                                   <!--      </select>-->
                                                   <!--      <i class="fas fa-caret-down sel_dwn-add_new"></i>-->
                                                   <!--   </td>-->
                                                   ...
                                                   <!--   </td>-->
                                                   <!--   <td class="adminData">-->
                                                   <!--      <input class="text-box single-line" id="PageSizeOptions" value="{{ $category->pagesizeoptions }}" name="pagesizeoptions" type="text" value="">-->
                                                   ...
                                                   <!--   </td>-->
                                                   <!--   <td class="adminData">-->
                                                   <!--      <input class="text-box single-line" id="Alias" name="alias" value="{{ $category->alias }}" type="text" value="">-->
                                                   ...
                                                   <!--         <option value="1" {{ $category->badgestyle == 1 ? 'selected' : '' }}><font style="vertical-align: inherit;">Products in Grid or Lines</font>-->
                                                   <!--         </option>-->
                                                   <!--      </select>-->
                                                   <!--      <i class="fas fa-caret-down sel_dwn-add_new"></i>-->
                                                   <!--   </td>-->
                                                         ...
                                                         <table class="add_new_tbl">
                                                            <tbody>
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <input id="MetaKeywords" name="cat_meta_key" type="text" value="{{ $category->cat_meta_key }}">
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <textarea cols="20" id="MetaDescription" name="cat_meta_discription" rows="2">{{ $category->cat_meta_discription }}</textarea>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <textarea cols="20" id="MetaTitle" name="cat_meta_title" rows="2">{{ $category->cat_meta_title }}</textarea>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <input class="text-box single-line" id="SeName" name="cat_meta_url" type="text" value="{{ $category->cat_meta_url }}">
                                                            ...
                                                            <tbody>
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     ...
                                                                     <input id="Locales_1__MetaKeywords" name="Locales[1].MetaKeywords" type="text" value="">
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <textarea cols="20" id="Locales_1__MetaDescription" name="Locales[1].MetaDescription" rows="2"></textarea>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <textarea cols="20" id="Locales_1__MetaTitle" name="Locales[1].MetaTitle" rows="2"></textarea>
                                                               ...
                                                               <tr>
                                                                  ...
                                                                  <td class="adminData">
                                                                     <input class="text-box single-line" id="Locales_1__SeName" name="Locales[1].SeName" type="text" value="">
