         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form action="{{ url('/admin/addcomission')}}" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                  <div class="cph">
                     <div class="row section-header justify-content-between">
                        <div class="cus_title col-md-4">
                           <font style="vertical-align: inherit;">Add Comission</font>
                        </div>
                                 ...
                                 <div class="tabbable tabs-left tabs-autoselect row new_horizon_tab_outer">
                                    <div class="col-lg-12 nav-aside">
                                       <ul class="nav nav-tabs nav-tabs-line">
                                          <li class="nav-item"><a href="#tab-1" data-toggle="tab" data-loaded="true" class="nav-link active show"><span class="tab-caption"><font style="vertical-align: inherit;">Add Comission</font></span></a></li>
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                    <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <select data-val="true" data-val-number="The field 'Badge stil' must be a number." data-val-required="" id="vendor_id" name="vendor_id" tabindex="-1" class="select2-hidden-accessible" aria-hidden="true">
                                                            <option selected="selected" value="">Select Vendor
                                                            </option>
                                                            @foreach($data as $order)
                                                            <option value="{{ $order->id }}"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">{{ $order->name }}</font></font>
                                                            </option>
                                                            @endforeach
                                                         </select>
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="comission_rate" type="text" value="">                                
                                                      </td>
                                                   </tr>
                                                </tbody>
                                             </table>
