         ...
         <div class="row">
            <div class="col-xl-12">
               <div class="card dasbdr_wrapper">
                  <form id="addcat" action="{{ url('/admin/addproduct')}}" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                  <div class="cph">
                                             ...
                                             <table class="add_new_tbl">
                                                <tbody>
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="BadgeStyle"><font style="vertical-align: inherit;">RECOMMENDED PRODUCT</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" title="Retrieves or sets the type of brand to be displayed next to the category link in the menus"  data-toggle="tooltip" data-placement="left"><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
                                                         <select class="selectpicker" name="similar_product[]" multiple data-live-search="true">
                                                          @foreach($product as $pro)
                                                            <option value="{{ $pro->id }}"><font style="vertical-align: inherit;">{{ $pro->product_name }}</font></font>
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                      </td>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="product_name_en" type="text" value="">                                
                                                      </td>
                                                    </tr>
                                                    <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="product_name_ar" type="text" value="">                                
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <textarea class="text-box single-line" name="product_short_dis_en" type="text" value="">  </textarea>                               
                                                      </td>
                                                   </tr>
                                                   <tr>
                                                      <td class="adminTitle">
                                                      ...
                                                      <td class="adminData">
                                                         <textarea class="text-box single-line" name="product_short_dis_ar" type="text" value="">  </textarea>                               
                                                      </td>
                                                   </tr>
                                                   <tr class="brek"> </tr>
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <textarea class="text-box single-line" name="product_full_dis_en" type="text" value=""> </textarea>                                
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <textarea class="text-box single-line" name="product_full_dis_ar" type="text" value=""> </textarea>                                
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="product_sku" type="text" value="">                                
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <div>
                                                            <input class="jscolor" name="background_color" value="#f6b73c">
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="product_price" type="text" value="">                   
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="product_offer_price" type="text" value="">                   
                                                      </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="">
                                                        <p>From: <input type="text" name="from_date" id="fromDate"> TO <input type="text" name="to_date" id="toDate"></p>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <!-- Modal -->
                                                          ...
                                                          <button id="myBtn" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal">Add Attribute</button>
                                                        </td>
                                                   </tr>
                                                   ...
                                                   <tr>
                                                      ...
                                                      <td class="adminData">
                                                         <input class="text-box single-line" name="product_qty" type="text" value="">                   
                                                      </td>
                                                   </tr>
                                                   <!--<tr>-->
                                                   <!--   <td class="adminTitle">-->
                                                            ...
                                                            <div class="fileupload-controls">
                                                               <div class="fileupload">
                                                                  <div class="fileupload-buttons">
                                                                     <img id="image_preview_container" src="{{ URL::to('/dokan/public') }}/product_images/image-preview.png"
                                                   ...
                                                   <tr>
                                                      <td class="adminTitle">
                                                         <div class="ctl-label">
                                                            <label for="AllowCustomersToSelectPageSize"><font style="vertical-align: inherit;">Product Brand</font>
                                                            </label><a class="hint" href="#" onclick="return false;" tabindex="-1" data-toggle="tooltip" data-placement="left" title="Whether customers can choose the page size from a predefined list of options."><i class="fa fa-question-circle"></i></a>
                                                         </div>
                                                      </td>
                                                      <td class="adminData">
