                                       ...
                                       <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                          <thead class="t-grid-header">
                                             <tr>
                                                ...
                                                <th class="t-header" scope="col" style="text-align:center;"><a class="t-link" href="">Remove From New Arrival</a></th>
                                             </tr>
                                          </thead>
                                          <tbody>
                                             @foreach($data as $row)
                                             <tr id="tr_{{$row->id}}">
                                                ...
                                                @endif
                                                <td align="center"><a href="{{ url('/admin/product/new', $row->id )}}">Remove</a></td>
                                             </tr>
                                             @endforeach
                                          </tbody>
                                       </table>
