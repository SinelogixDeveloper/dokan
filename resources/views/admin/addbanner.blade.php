            ...
            <div class="row">
               <div class="col-xl-12">
                  <div class="card dasbdr_wrapper">
                     <form id="addcat" action="{{ url('/admin/addbanner')}}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                     {{ csrf_field() }}
                     <div class="cph">
                        <div class="row section-header justify-content-between">
                           <div class="cus_title col-md-4">
                              <font style="vertical-align: inherit;">Add Banner</font>
                           </div>
                                                ...
                                                <table class="add_new_tbl">
                                                   <tbody>
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannertitle_en" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannertitle_ar" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannerdiscription_en" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                      <tr>
                                                         <td class="adminTitle">
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannerdiscription_ar" type="text" value="">                                
                                                         </td>
                                                      </tr>
                                                         ...
                                                         <div class="fileupload-container">
                                                            <div class="fileupload-thumb-stage">
                                                               <div class="fileupload-thumb">
                                                                  <input class="hidden" data-val="true" data-val-number="The field 'Bild' must be a number." id="" name="bannerimages" type="hidden" value="">
                                                               </div>
                                                            </div>
                                                            <div class="fileupload-controls">
                                                               <div class="fileupload">
                                                                  <div class="fileupload-buttons">
                                                                     ...
                                                                     <input type="file" name="bannerimages" id="bannerimages">
                                                                     </span>                                              
                                                                  </div>
                                                               </div>
                                                            </div>
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td class="adminData">
                                                            <input class="text-box single-line" name="bannerurl" type="text" value="">                                
                                                         </td>
                                                      </tr>
