                  ...
                  <div class="cph">
                     ...
                     <div class="section-header row">
                        ...
                        <div class="cus_title col-md-8">
                           ...
                           <i class="fa fa-sitemap"></i> Order Request List
                        ...
                        <div class="options col-md-4 d-flex justify-content-end">
                           ...
                           <div class="btn-group">
                              ...
                              <div class="dropdown-menu dropdown-menu-right">
                                 ...
                                 <a href="{{ url('admin/vendor_report/excelexport',$vendor_id)}}" class="dropdown-item export-data-button">
                                 ...
                                 <a href="{{ url('admin/vendor_report/csvexport',$vendor_id)}}" class="dropdown-item export-data-button">
                                    ...
                                    <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                       ...
                                       <thead class="t-grid-header">
                                          ...
                                          <tr>
                                             ...
                                             <th scope="col"><span class="t-link">RefrenceID</span></th>

                                             {{-- <th scope="col"><span class="t-link">Product Name</span></th> --}}

                                             <th scope="col"><span class="t-link">Buyer Name</span></th>

                                             {{-- <th scope="col"><span class="t-link">Product Price</span></th> --}}

                                             {{-- <th scope="col"><span class="t-link">Total Price</span></th> --}}

                                             <th scope="col"><span class="t-link">Payment Status</span></th>

                                             <th scope="col"><span class="t-link">Order Status</span></th>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td><a href="{{ url('vendor/order_request/view', $row->id )}}">View</a></td>
