                     ...
                     <div class="cph">
                        <div class="row section-header justify-content-between">
                           ...
                           <div class="options float-right">
                              ...
                              <a href="{{ url('vendor/addproduct')}}" class="btn btn-primary mtp">
                              <i class="fa fa-plus"></i>
                              <span>Add new</span>
                              </a>
                              <button type="submit" id="delete-selected" class="btn btn-secondary btn-to-danger mtp deleteAll" data-url="{{ url('vendor/product/DeleteAll') }}">
                        ...
                        <div class="cus_dashboard">
                            <form action="{{ url('/vendor/product_filter')}}" method="post" >
                           {{ csrf_field() }}
                              <div class="row mt-3 grid-filter">
                                 <div class="col-sm-6 col-lg-4 col-xl-3 form-group">
                                    <div class="ctl-label">
                                       <label for="SearchCategoryName">Product name</label><a class="hint" href="#" onclick="return false;" tabindex="-1" title="Category" data-toggle="tooltip" data-placement="left"><i class="fa fa-question-circle"></i></a>
                                    </div>
                                    <input class="form-control" id="SearchProductName" name="product_name" type="text" value="{{$name}}">
                                 </div>
                                 <div class="col-sm-6 col-lg-4 col-xl-3 form-group">
                                    <div class="ctl-label">
                                       <label>&nbsp;</label>
                                       ...
                                       <table cellspacing="0" class="table cus_tbl table-striped m-0">
                                          ...
                                          <tbody>
                                             ...
                                             <tr id="tr_{{$row->id}}">
                                                ...
                                                <td>
                                                   <div class="zoomable-thumb-container"><img alt="{{$row->id}}" src="{{ URL::to('/auraqatar/public/') }}/product_images/{{ $row->featured_images }}" class="zoomable-thumb" style="position: relative;"></div>
                                                </td>
                                                <td><span class="badge badge-secondary d-none mr-1"></span><a href="{{ url('vendor/product/edit', $row->id )}}">{{ $row->product_name }}</a></td>
