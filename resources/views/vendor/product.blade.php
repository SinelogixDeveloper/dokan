         ...
         <div class="row">
            ...
            <div class="col-xl-12">
               ...
               <div class="card dasbdr_wrapper">
                  ...
                  <form id="addcat" action="{{ url('/vendor/addproduct')}}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="fileupload-controls">
                                                               ...
                                                               <div class="fileupload">
                                                                  ...
                                                                  <div class="fileupload-buttons">
                                                                     ...
                                                                     <img id="image_preview_container" src="{{ URL::to('/auraqatar/public') }}/product_images/image-preview.png"
